        ...
        <footer className="flex items-center justify-between leading-none p-2 md:p-4">
          ...
          >
            {!props.disabled ? (
              ...
              <button className={`dark:text-black bg-gradient-to-b from-primary_orange-0 to-orange-600 hover:bg-gradient-to-t text-white w-full font-bold py-3 px-5 rounded mb-3`}>
                {props.btntext}
              </button>
            )}
          </a>
